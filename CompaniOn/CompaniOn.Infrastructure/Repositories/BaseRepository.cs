...
namespace CompaniOn.Infrastructure
{
       ...
       where TSearchObject : BaseSearchObject
    {
        ...
        public async Task<AIConversation?> GetLastEntry(int id, CancellationToken cancellationToken = default)
        {
            var getList = DatabaseContext.AIConversations.Where(e => e.UserId == id);
